...
{
//	cout << "in the print function: " << n->key << endl;
...
//	cout << "el_to_nd() in CS302_Midi(string file)" << endl;
    el_to_nd();
...
//	cout << "nd_to_el() in CS302_Midi(string file)" << endl;
    nd_to_el();
...
//	cout << "in the write method!!! woah!" << endl;
